...
#include "AllFour/Public/DJ/DoodleJumpGameModeBase.h"
#include "UObject/ConstructorHelpers.h"

ADoodleJumpGameModeBase::ADoodleJumpGameModeBase()
{
	...
	static const TSubclassOf<APawn> PlayerPawnClass =
		ConstructorHelpers::FClassFinder<APawn>(TEXT("/Game/DJ/Characters/BP_DoodleJumpCharacter")).Class;
